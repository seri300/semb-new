package cz.sereda.semb.repository;

import cz.sereda.semb.SemBApp;
import cz.sereda.semb.config.Constants;
import cz.sereda.semb.config.audit.AuditEventConverter;
import cz.sereda.semb.domain.PersistentAuditEvent;
...
import static cz.sereda.semb.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
